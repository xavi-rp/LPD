...
# Data set preparation for the case study
...
In the first version of this package presented here, the main function uses multi-band 'tiff' raster, one per variable and with each band for one of the years of the time series. However, some functions are included in the package to pre-read in NetCDF and BIL files(i.e. "read_nc()" and "read_bil()", respectivelly)
