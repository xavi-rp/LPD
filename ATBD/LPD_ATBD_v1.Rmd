...
```{r echo=FALSE}
figCombAss <- fig_num(name = "figCombAss", caption = "blu blu blu")
tabLookUpCombAss <- table_num(name = "tabLookUpCombAss", caption = "Lookup table for the combination of the two branches assessment (i.e. Long-Term Channge Map of standing biomass and Current Status Map of Land-Productivity of cyclic fraction) to derive the Land-Productivity Dynamics categories")
...
names(LookUpCombAss) <- c("Steadiness I.", "Baseline L.", "State Change", "Local Sc. < 50%", "Local Sc.  >= 50%")
